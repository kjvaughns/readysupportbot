...
const ADMINISTRATOR_PERMISSIONS: Permission[] = [
  ...SUPPORT_PERMISSIONS,
  'deactivate_accounts',
  // Signing another person out of Readymode is disruptive to whoever is using
  // that seat, so it sits with Administrators by default.
  'force_logout',
  'manage_members',
];
...
export const ACTION_PERMISSIONS: Record<ActionType, Permission | null> = {
  ...
  CLEAR_ALL_LICENSES: 'clear_all_licenses',
  ...
  VIEW_PLAYLISTS: 'check_agent_status',
  ASSIGN_PLAYLIST: 'configure_playlists',
  REMOVE_PLAYLIST: 'configure_playlists',
  TROUBLESHOOT: null,
