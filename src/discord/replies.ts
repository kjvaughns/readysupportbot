...
export const HELP_TEXT = [
  ...
  '',
  'Slash commands:',
  '/create_account · /create_accounts · /clear_license · /reset_password · /deactivate_account',
  '/agent_status · /license_usage · /set_states · /add_states · /remove_states · /view_states',
  '/connection_status · /recent_actions · /help',
  '',
